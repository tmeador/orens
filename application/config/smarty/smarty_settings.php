...
$config['smarty_template_dir'] = APPPATH . 'views/templates/';
...
|
*/
$config['smarty_compile_dir'] = APPPATH . 'views/templates_c/';
...
|--------------------------------------------------------------------------
|
| Set the plugin directory smarty will be using.
|
*/
$config['smarty_plugins_dir'] = APPPATH . 'libraries/smarty/libs/plugins/';